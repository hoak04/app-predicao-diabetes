...
colunas_ordenadas = [
    'Age', 'Sex_Male', 'Ethnicity_White', 'Ethnicity_Black', 'Ethnicity_Hispanic',
    ...
    'Dietary_Intake_Calories', 'Alcohol_Consumption_None', 
    'Alcohol_Consumption_Moderate', 'Smoking_Status_Never',
    'Smoking_Status_Former', 'Family_History_of_Diabetes',
